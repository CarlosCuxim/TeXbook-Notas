...
\begin{document}
  ...
  Primero, tenemos el entorno \texenvname{note} el cual define una caja para notas extra. Tiene un argumento opcional para cambiar el título, en el caso que no se indique el título será simplemente ``Nota''.

  \begin{texexample}
    \begin{notebox}[Nota extra]
      Ejemplo de nota
    \end{notebox}
  \end{texexample}
